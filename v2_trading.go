...
func (c *V2TradingMyOrders) ByDateCompleted(ctx context.Context, req *MyOrdersByDateCompletedRequest) (*MyOrdersByDateCompletedResponse, error) {
	...
	if req.ApplyAllAsset != "" {
		q.Add("applyAllAsset", req.ApplyAllAsset)
	}
...
func (c *V2TradingMyOrders) ByDateCompletedN(ctx context.Context, req *MyOrdersByDateCompletedRequest, n int) (*MyOrdersByDateCompletedResponse, error) {
